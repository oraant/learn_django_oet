# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-08-26 09:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tables', models.CharField(choices=[(b'Ora11gR2', b'[Table Collections] Oracle 11G R2')], max_length=30)),
                ('mysql', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mirror.MySQLServer')),
            ],
            options={
